...
#define LV_HOR_RES_MAX MYNEWT_VAL(LV_HOR_RES_MAX)
#define LV_VER_RES_MAX MYNEWT_VAL(LV_VER_RES_MAX)
 ...
 * - 32: ARGB8888
 */
#define LV_COLOR_DEPTH MYNEWT_VAL(LV_COLOR_DEPTH)
...
#define LV_COLOR_SCREEN_TRANSP MYNEWT_VAL(LV_COLOR_SCREEN_TRANSP)

/*Images pixels with this color will not be drawn (with chroma keying)*/
#define LV_COLOR_TRANSP MYNEWT_VAL(LV_COLOR_TRANSP)

/* Enable anti-aliasing (lines, and radiuses will be smoothed) */
#define LV_ANTIALIAS MYNEWT_VAL(LV_ANTIALIAS)

/* Default display refresh period.
 * Can be changed in the display driver (`lv_disp_drv_t`).*/
#define LV_DISP_DEF_REFR_PERIOD MYNEWT_VAL(LV_DISP_DEF_REFR_PERIOD)

/* Dot Per Inch: used to initialize default sizes.
 * E.g. a button with width = LV_DPI / 2 -> half inch wide
 * (Not so important, you can adjust it to modify default sizes and spaces)*/
#define LV_DPI MYNEWT_VAL(LV_DPI )
 ...
 */
#define LV_DISP_SMALL_LIMIT MYNEWT_VAL(LV_DISP_SMALL_LIMIT)
#define LV_DISP_MEDIUM_LIMIT MYNEWT_VAL(LV_DISP_MEDIUM_LIMIT)
#define LV_DISP_LARGE_LIMIT MYNEWT_VAL(LV_DISP_LARGE_LIMIT)

/* Type of coordinates. Should be `int16_t` (or `int32_t` for extreme cases) */
#if MYNEWT_VAL(LV_COORDINATE_TYPE)==LV_COORDINATE_INT32
